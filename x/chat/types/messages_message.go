...
func NewMsgUpdateMessage(creator string, id uint64, body string) *MsgUpdateMessage {
...
var _ sdk.Msg = &MsgDeleteMessage{}

func NewMsgDeleteMessage(creator string, id uint64) *MsgDeleteMessage {
